...
export default function GoalsPage() {
  ...
  async function fetchGoals() {
    ...
    const res = await fetch(`/api/user-data?email=${user?.email}&table=goals`)
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-500 text-sm -mt-4">Edit your goals for each life area. Luma will use these to guide your daily check-ins.</p>
